...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/modularis
   # Navigate to the newly cloned directory
   cd modularis
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/modularis/modularis
...
[already been reported]: https://github.com/modularis/modularis/issues
[fork this project]:     https://github.com/modularis/modularis/fork
